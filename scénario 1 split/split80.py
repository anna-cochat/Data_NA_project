...
coords_base = pd.read_csv("famd_coordinates.csv")
...
train_df.to_csv("train80.csv")
test_df.to_csv("test80.csv")

print("train.csv saved :", len(train_df))
print("test.csv saved  :", len(test_df))