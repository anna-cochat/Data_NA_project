...
#df_imputation => tableau avec touté les colonnes, df_model => tableau avec que les variables numérisées
df_model.to_csv('/Users/matteoschweizer/Documents/GitHub/Data_NA_project/data/df_num_cleaned.csv', index=False)
df_imputation.to_csv('/Users/matteoschweizer/Documents/GitHub/Data_NA_project/data/df_all_cleaned.csv', index=False)